...
begin
  ...
  begin
    ...
    begin
      ShowMessage('Antes de iserir um item, informe a quantidade!');
    ...
    Persistence.AlterarPedido(StrToInt(edtIdPedido.Text), StrToFloat(edtValor.Text), StrToFloat(edtQuantidade.Text));
    ...
    begin
      ...
      Persistence.InserirReceita(StrToInt(edtIdPedido.Text));
    end;
